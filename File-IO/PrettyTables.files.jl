#=  ================================================================================================
    PrettyTables.jl/src/files.jl
      A great example of file read/write in julia, especially temp files
          and move after writing

    Function to include a table in a file.
    
    author:     https://github.com/ronisbr/PrettyTables.jl/blob/master/src/files.jl
=   ===============================================================================================#
...
If the user wants to also remove the opening and ending tags, then pass the
keyword `remove_tags = true`.
